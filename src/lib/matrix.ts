...
export type Geometry = {
   ...
   * qu'une LED retenue déborde du cercle nominal de presque une demi-diagonale.
   * Sur une grille de 13 la plus lointaine est à 6,403 et non 6,5 ; sur une de
   * 25, à 12,369 et non 12,5. C'est cette valeur qui dit quel cerne minimal
   * garde tous les coins de LED à l'intérieur du hublot.
   */
  maxDist: number;
